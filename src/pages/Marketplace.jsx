      ...
      <div className="max-w-7xl mx-auto space-y-12 pb-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          {[
            ...
            <div key={i} className="bg-white dark:bg-[#111827] p-6 rounded-[12px] border border-[#E8E8E8] dark:border-[#1E2A3A]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-12">
            ...
            <div className="bg-white dark:bg-[#111827] p-8 rounded-[12px] border border-[#E8E8E8] dark:border-[#1E2A3A]">
              ...
              <div className="space-y-10">
                <div className="space-y-4">
                  <p className="text-[9px] font-black text-[#1A1A1A] dark:text-[#FAFAF8] uppercase tracking-widest">Yield Range</p>
                  <div className="flex gap-2 flex-wrap">
                    {['<3%', '3-5%', '5-8%', '8%+'].map(y => (
                      <button key={y} className="px-3 py-1 rounded bg-[#FAFAF8] dark:bg-[#0A0F1E] border border-[#E8E8E8] dark:border-[#1E2A3A] text-[9px] font-black text-[#8C8C8C] hover:border-[#F5A623] transition-all">{y}</button>
                    ))}
                  </div>
                </div>

                <div className="space-y-4">
                  <p className="text-[9px] font-black text-[#1A1A1A] dark:text-[#FAFAF8] uppercase tracking-widest">Risk Frontier</p>
                  <div className="space-y-2">
                    {['Sovereign (Low)', 'Syndicate (Mid)', 'Emergent (High)'].map(r => (
                      <label key={r} className="flex items-center gap-3 cursor-pointer group">
                        <div className="w-4 h-4 rounded border border-[#E8E8E8] dark:border-[#1E2A3A] bg-[#FAFAF8] dark:bg-[#0A0F1E] group-hover:border-[#F5A623]"></div>
                        <span className="text-[10px] font-black text-[#8C8C8C] uppercase group-hover:text-[#1A1A1A] dark:text-[#FAFAF8]">{r}</span>
                      </label>
                    ))}
                  </div>
                </div>
          ...
          <div className="lg:col-span-3 space-y-8">
            <div className="flex justify-between items-center">
               <h3 className="text-xl font-black font-cabinet text-[#1A1A1A] dark:text-[#FAFAF8] uppercase tracking-widest">Vouching Opportunities</h3>
               <div className="flex bg-white dark:bg-[#111827] p-1 rounded-lg border border-[#E8E8E8] dark:border-[#1E2A3A]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {[
                ...
                <div key={i} className="bg-white dark:bg-[#111827] p-8 rounded-[12px] border border-[#E8E8E8] dark:border-[#1E2A3A] hover:border-[#F5A623]/40 transition-all group relative overflow-hidden">
                  ...
                  <div className="flex items-center gap-4 mb-6">
                    ...
                    <div>
                      <p className="text-sm font-black text-[#1A1A1A] dark:text-[#FAFAF8]">{loan.name}</p>
                  ...
                  <div className="space-y-6">
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        ...
                        <p className="text-xl font-black text-[#1A1A1A] dark:text-[#FAFAF8] font-cabinet">{loan.amount}</p>
                      </div>
                      <div>
                    ...
                    <div className="flex flex-wrap gap-2">
                       {loan.tags.map(t => (
                         <span key={t} className="px-2 py-0.5 rounded bg-[#FAFAF8] dark:bg-[#0A0F1E] border border-[#E8E8E8] dark:border-[#1E2A3A] text-[8px] font-black text-[#8C8C8C] uppercase">{t}</span>
                       ))}
                    </div>
