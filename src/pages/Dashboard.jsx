    ...
    <AppShell pageTitle="Solvent Terminal" pageSubtitle="Real-time Capital & Trust Synthesis">
      <div className="max-w-7xl mx-auto space-y-10 pb-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Trust Score Radial */}
          <div className="bg-[#111827] p-8 rounded-[12px] border border-[#1E2A3A] flex flex-col items-center group transition-all hover:border-[#F5A623]/50">
            <div className="relative w-40 h-40">
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center">
                <span className="text-4xl font-black font-cabinet text-[#FAFAF8]">68</span>
                <span className="text-[10px] text-[#8C8C8C] font-black uppercase tracking-widest mt-1">/ 100</span>
              </div>
            </div>
            <div className="text-center mt-6">
              <h4 className="text-sm font-black text-[#FAFAF8] uppercase tracking-widest font-cabinet">Silver Tier</h4>
              <p className="text-[10px] font-bold text-[#1D9E75] uppercase tracking-widest mt-1">+6 pts this month</p>
            </div>
          </div>

          {/* Borrow Limit */}
          <div className="bg-[#111827] p-8 rounded-[12px] border border-[#1E2A3A] flex flex-col justify-center group transition-all hover:border-[#F5A623]/50">
            <p className="text-[11px] font-black text-[#8C8C8C] uppercase tracking-widest mb-4">Borrow Limit</p>
            <div className="flex items-center gap-4">
              <h3 className="text-4xl font-black tracking-tighter text-[#FAFAF8] font-cabinet">$200.00</h3>
          ...
          <div className="bg-[#111827] p-8 rounded-[12px] border border-[#1E2A3A] flex flex-col justify-center group transition-all hover:border-[#F5A623]/50">
            ...
            <h3 className="text-4xl font-black tracking-tighter text-[#FAFAF8] font-cabinet">$47.50</h3>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-[#111827] p-10 rounded-[12px] border border-[#1E2A3A]">
            <h4 className="text-lg font-black font-cabinet tracking-tight text-[#FAFAF8] mb-8 uppercase tracking-widest">Vouch Network Health</h4>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-10 h-48 items-center justify-center relative">
               ...
               <div className="space-y-6 relative z-10 w-full col-span-2">
                {[
                  ...
                  <div key={i} className="flex items-center justify-between bg-[#0A0F1E]/50 p-3 rounded-lg border border-[#1E2A3A]/50">
                    <div className="flex items-center gap-4">
                      <div className="w-10 h-10 rounded-full bg-[#0A0F1E] border border-[#F5A623]/20 flex items-center justify-center text-[10px] font-bold text-[#F5A623]">
                        {node.name.charAt(0)}
                      </div>
                      <div>
                        <p className="font-bold text-sm text-[#FAFAF8]">{node.name}</p>
          ...
          <div className="bg-[#111827] p-10 rounded-[12px] border border-[#1E2A3A]">
            <div className="flex justify-between items-start mb-8">
              <h4 className="text-lg font-black font-cabinet tracking-tight text-[#FAFAF8] uppercase tracking-widest">Repayment Rhythm</h4>
            ...
            <div className="space-y-10">
              <div className="p-6 rounded-xl bg-[#0A0F1E] border border-[#1E2A3A]">
                 <div className="flex justify-between mb-4">
                    <p className="text-[10px] font-black text-[#8C8C8C] uppercase tracking-widest">Next Installment</p>
                    <p className="text-[12px] font-black text-[#FAFAF8]">$15.80 • Oct 12</p>
                 </div>
              ...
              <div className="flex items-center gap-6 p-6 rounded-xl bg-[#1D9E75]/5 border border-[#1D9E75]/10">
                ...
                <div>
                  <p className="text-xl font-black text-[#FAFAF8] font-cabinet tracking-tight">3 On-Time Streak</p>
        ...
        {/* BOTTOM ROW: Activity */}
        <div className="bg-[#111827] p-10 rounded-[12px] border border-[#1E2A3A]">
          <h4 className="text-lg font-black font-cabinet tracking-tight text-[#FAFAF8] uppercase tracking-widest mb-10">Recent On-Chain Activity</h4>
                ...
                {[
                  ...
                  <tr key={i} className="hover:bg-white/[0.02] group transition-all duration-300">
                    <td className="py-6 flex items-center gap-3">
                      <div className={`p-2 rounded-lg bg-[#0A0F1E] border border-[#1E2A3A] transition-colors group-hover:border-[#F5A623]/30 ${tx.color}`}>
                        <iconify-icon icon={tx.icon}></iconify-icon>
                      </div>
                      <span className="font-bold text-sm text-[#FAFAF8]">{tx.type}</span>
                    </td>
