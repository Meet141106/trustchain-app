  ...
  return (
    <AppShell pageTitle="Sovereign Audit" pageSubtitle="Credit Identity Verification">
      <div className="max-w-7xl mx-auto space-y-12 pb-24">
        ...
        <div className="bg-[#111827] p-10 rounded-[12px] border border-[#1E2A3A] flex flex-col md:flex-row justify-between items-center gap-8">
           <div className="flex items-center gap-6">
              <div className="w-20 h-20 rounded-full bg-[#0A0F1E] border-2 border-[#F5A623] flex items-center justify-center font-black text-2xl text-[#FAFAF8]">M</div>
              <div>
                 <h2 className="text-2xl font-black font-cabinet text-[#FAFAF8]">Meet_Projects</h2>
           ...
           <div className="flex gap-12">
              <div className="text-center">
                 ...
                 <p className="text-2xl font-black text-[#FAFAF8]">$200.00</p>
              </div>
              <div className="text-center">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
          ...
          <div className="bg-[#111827] p-10 rounded-[12px] border border-[#1E2A3A] flex flex-col items-center">
             <h4 className="text-[10px] font-black text-[#F5A623] uppercase tracking-[0.3em] mb-12 self-start">Reputation DNA Synthesis</h4>
             
             <div className="relative w-64 h-64 border border-[#1E2A3A] rounded-full flex items-center justify-center">
                {/* Simulated Radar Chart */}
                <div className="absolute inset-0 border border-[#1E2A3A] rounded-full scale-75 opacity-50"></div>
                <div className="absolute inset-0 border border-[#1E2A3A] rounded-full scale-50 opacity-20"></div>
                ...
                <p className="text-5xl font-black text-[#FAFAF8] font-cabinet z-10">68</p>
             </div>
             ...
             <div className="mt-12 grid grid-cols-2 gap-6 w-full">
                {[
                  ...
                  <div key={i} className="flex justify-between items-center p-4 rounded bg-[#0A0F1E] border border-[#1E2A3A]">
                     <span className="text-[9px] font-black text-[#8C8C8C] uppercase tracking-widest">{s.label}</span>
                     <span className="text-xs font-black text-[#FAFAF8]">{s.val}</span>
                  </div>
                ))}
             </div>
          </div>
          ...
          <div className="space-y-8">
             <div className="bg-[#111827] p-10 rounded-[12px] border border-[#1E2A3A]">
                ...
                <div className="space-y-6">
                   {[
                     ...
                     <div key={i} className={`flex items-center justify-between p-6 rounded-xl border transition-all ${v.active ? 'bg-[#1D9E75]/5 border-[#1D9E75]/20' : 'bg-[#0A0F1E] border-[#1E2A3A]'}`}>
                        <div className="flex items-center gap-4">
                           <iconify-icon icon={v.icon} className={`text-xl ${v.active ? 'text-[#1D9E75]' : 'text-[#8C8C8C]'}`}></iconify-icon>
                           <p className="text-[10px] font-black text-[#FAFAF8] uppercase tracking-widest">{v.label}</p>
                        </div>
             ...
             <div className="p-8 rounded-[12px] bg-[#F59E0B]/5 border border-[#F59E0B]/10">
                ...
                <p className="text-[10px] text-[#FAFAF8] leading-relaxed">Completing the **"On-chain Governance"** module will likely boost your trust score by **+12 pts** and unlock a **$500.00** borrow limit.</p>
             </div>
          </div>
        </div>
