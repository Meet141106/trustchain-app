    ...
    <AppShell pageTitle="Lender Portfolio" pageSubtitle="Capital Performance Monitor">
      <div className="max-w-7xl mx-auto space-y-12 pb-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
           {[
             { label: 'Deployed Principal', val: '$4,250.00', sub: 'Across 14 Facilities', color: 'text-[#FAFAF8]' },
             ...
             <div key={i} className="bg-[#111827] p-10 rounded-[12px] border border-[#1E2A3A] relative overflow-hidden group">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
          ...
          <div className="lg:col-span-2 bg-[#111827] rounded-[12px] border border-[#1E2A3A] overflow-hidden">
             <div className="p-8 border-b border-[#1E2A3A] flex justify-between items-center">
                <h3 className="text-sm font-black font-cabinet text-[#FAFAF8] uppercase tracking-widest">Active Deployments</h3>
             ...
             <div className="divide-y divide-[#1E2A3A]">
                {[
                  ...
                  <div key={i} className="p-8 hover:bg-[#0A0F1E] transition-all flex items-center justify-between group">
                     <div className="flex items-center gap-6">
                        ...
                        <div>
                           <p className="text-sm font-black text-[#FAFAF8]">{d.name}</p>
                           <p className="text-[9px] font-black text-[#8C8C8C] uppercase tracking-widest mt-1">Due in {d.maturity}</p>
                        </div>
                     </div>
                     <div className="text-right flex items-center gap-12">
                        <div>
                           <p className="text-sm font-black text-[#FAFAF8]">{d.amount}</p>
                           <p className="text-[9px] font-black text-[#1D9E75] uppercase tracking-widest mt-1">{d.yield} Yield</p>
                        </div>
                        <div className="hidden md:block">
                           <button className="px-6 py-3 rounded border border-[#1E2A3A] text-[9px] font-black uppercase tracking-widest text-[#8C8C8C] group-hover:text-[#F5A623] group-hover:border-[#F5A623] transition-all">Audit</button>
                        </div>
                     </div>
                  </div>
                ))}
          ...
          <div className="space-y-8">
                ...
                <div className="space-y-6">
                   ...
                   <div className="pt-6 border-t border-[#1E2A3A]">
                      <div className="flex justify-between items-center mb-4">
                         ...
                         <span className="text-sm font-black text-[#FAFAF8]">1,420 QP</span>
                      </div>
             ...
             <div className="bg-[#F5A623]/5 p-8 rounded-[12px] border border-[#F5A623]/10 relative overflow-hidden">
                ...
                <p className="text-[10px] text-[#FAFAF8] leading-relaxed">Your "Social Voucher" status grants you a **+0.4%** yield bonus on all active deployments.</p>
             </div>
          </div>
        </div>
      </div>
