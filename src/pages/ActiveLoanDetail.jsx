      ...
      <div className="max-w-7xl mx-auto space-y-10 pb-24">
        ...
        <div className="bg-[#111827] p-10 rounded-[12px] border border-[#1E2A3A] flex flex-col md:flex-row justify-between items-start md:items-center gap-8 relative overflow-hidden">
          ...
          <div>
            ...
            <h2 className="text-5xl font-black font-cabinet text-[#FAFAF8] tracking-tighter mb-2">$75.00</h2>
            <div className="flex gap-6 mt-4">
               <div>
                  <p className="text-[9px] font-black text-[#8C8C8C] uppercase tracking-widest mb-1">Disbursed</p>
                  <p className="text-xs font-bold text-[#FAFAF8]">Oct 01, 2024</p>
               </div>
               <div>
                  <p className="text-[9px] font-black text-[#8C8C8C] uppercase tracking-widest mb-1">Due Date</p>
                  <p className="text-xs font-bold text-[#FAFAF8]">Dec 01, 2024</p>
               </div>
               <div>
          ...
          <div className="flex flex-col items-end">
            ...
            <div className="text-right">
              ...
              <p className="text-xl font-black text-[#FAFAF8] font-mono">$13.12</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-[#111827] p-10 rounded-[12px] border border-[#1E2A3A]">
          <h4 className="text-lg font-black font-cabinet tracking-tight text-[#FAFAF8] uppercase tracking-widest mb-10 text-center">Capital Health Monitor</h4>
        ...
        <div className="bg-[#111827] p-10 rounded-[12px] border border-[#1E2A3A]">
          <div className="flex justify-between items-center mb-12">
            <h4 className="text-lg font-black font-cabinet tracking-tight text-[#FAFAF8] uppercase tracking-widest">Repayment Timeline</h4>
            ...
            {[
              ...
              <div key={i} className="relative z-10 flex flex-col items-center gap-4">
                ...
                <div className="text-center">
                  <p className="text-[10px] font-black text-[#FAFAF8] uppercase tracking-widest mb-1">{step.status}</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          {/* AI RISK FRONTIER */}
          <div className="lg:col-span-2 bg-[#111827] p-10 rounded-[12px] border border-[#1E2A3A]">
            <h4 className="text-lg font-black font-cabinet tracking-tight text-[#FAFAF8] uppercase tracking-widest mb-10">AI Risk Frontier</h4>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
               <div className="text-center p-6 rounded-xl bg-[#0A0F1E] border border-[#1E2A3A]">
               ...
               <div className="text-center p-6 rounded-xl bg-[#0A0F1E] border border-[#1E2A3A]">
                  ...
                  <p className="text-2xl font-black text-[#FAFAF8] font-cabinet">$200</p>
            ...
            <div className="mt-10 flex gap-4">
              ...
              <button disabled className="px-6 py-4 border border-[#1E2A3A] text-[#8C8C8C] rounded-[8px] text-[10px] font-black uppercase tracking-widest opacity-50 cursor-not-allowed">
                Restructure
              </button>
            </div>
          </div>
          ...
          <div className="bg-[#111827] p-8 rounded-[12px] border border-[#1E2A3A]">
            ...
            <div className="space-y-6">
              {[
                ...
                <div key={i} className="flex items-center justify-between p-4 rounded-lg bg-[#0A0F1E] border border-[#1E2A3A]/50">
                   <div className="flex items-center gap-3">
                      <div className="w-8 h-8 rounded-full bg-[#1E2A3A] flex items-center justify-center font-black text-xs text-[#FAFAF8] border border-[#F5A623]/20">{v.avatar}</div>
                      <div>
                        <p className="text-xs font-bold text-[#FAFAF8]">{v.name}</p>
