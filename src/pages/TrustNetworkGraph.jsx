    ...
    <AppShell pageTitle="Trust Network" pageSubtitle="Social Vouch Hub">
      <div className="max-w-7xl mx-auto space-y-12 pb-24">
        ...
        <div className="bg-[#111827] p-10 rounded-[12px] border border-[#1E2A3A] flex flex-col md:flex-row justify-between items-center gap-8">
           <div>
              <h3 className="text-xl font-black font-cabinet text-[#FAFAF8] uppercase tracking-widest">Syndicate Connectivity</h3>
           ...
           <div className="bg-[#1E2A3A] px-6 py-4 rounded-[10px] flex gap-8">
              <div className="text-center">
                 ...
                 <p className="text-lg font-black text-[#FAFAF8]">24</p>
              </div>
              <div className="text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
           {[
             ...
             <div key={i} className="bg-[#111827] p-8 rounded-[12px] border border-[#1E2A3A] group hover:border-[#F5A623] transition-all">
                <div className="w-12 h-12 bg-[#0A0F1E] rounded-lg flex items-center justify-center text-[#F5A623] mb-6 group-hover:bg-[#F5A623] group-hover:text-black transition-all">
                   <iconify-icon icon={c.icon} className="text-2xl"></iconify-icon>
                </div>
                <h4 className="text-sm font-black text-[#FAFAF8] mb-2">{c.name}</h4>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
           ...
           <div className="bg-[#111827] rounded-[12px] border border-[#1E2A3A] overflow-hidden">
              <div className="p-8 border-b border-[#1E2A3A]">
                 <h3 className="text-sm font-black font-cabinet text-[#FAFAF8] uppercase tracking-widest">Active Vouch Stream</h3>
              </div>
                 ...
                 {[
                   ...
                   <div key={i} className="flex justify-between items-center">
                      <div className="flex items-center gap-4">
                         ...
                         <span className="text-[10px] font-bold text-[#FAFAF8] uppercase tracking-widest">{v.from}</span>
                      </div>
           ...
           <div className="bg-[#F5A623]/5 p-10 rounded-[12px] border border-[#F5A623]/10 flex flex-col justify-center items-center text-center">
              ...
              <h4 className="text-lg font-black text-[#FAFAF8] font-cabinet mb-2">Request Social Attestation</h4>
