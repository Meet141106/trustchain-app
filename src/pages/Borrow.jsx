    ...
    <AppShell pageTitle="Credit Drawdown" pageSubtitle="Capital Access Architecture">
      <div className="max-w-7xl mx-auto space-y-12 pb-24">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-[#111827] p-8 rounded-[12px] border-2 border-[#F5A623] flex flex-col relative overflow-hidden group">
            ...
            <h3 className="text-xl font-black font-cabinet text-[#FAFAF8] mb-3 uppercase tracking-widest">Community Vouching</h3>
            ...
            <div className="space-y-6 mb-10 flex-1">
              <div>
                <p className="text-[9px] font-black text-[#FAFAF8] uppercase tracking-[0.2em] mb-4">Voucher Status (1/3)</p>
              ...
              <div className="flex justify-between items-end border-t border-[#1E2A3A] pt-6">
          ...
          <div className="bg-[#111827] p-8 rounded-[12px] border border-[#1E2A3A] flex flex-col group hover:border-[#F5A623]/30 transition-all">
            <div className="w-14 h-14 rounded-xl bg-[#1E2A3A] border border-[#1E2A3A] flex items-center justify-center text-[#8C8C8C] mb-8 group-hover:text-[#F5A623]">
              <iconify-icon icon="lucide:shield-check" className="text-2xl"></iconify-icon>
            </div>
            <h3 className="text-xl font-black font-cabinet text-[#FAFAF8] mb-3 uppercase tracking-widest">Digital Collateral</h3>
            <p className="text-xs text-[#8C8C8C] leading-relaxed mb-8">Lock crypto into escrow. Auto-released on full repayment.</p>
            
            <div className="space-y-6 mb-10 flex-1">
              <div className="p-4 rounded-lg bg-[#0A0F1E] border border-[#1E2A3A]">
                <p className="text-[9px] font-black text-[#8C8C8C] uppercase tracking-widest mb-1">Required Base</p>
                <p className="text-sm font-black text-[#FAFAF8]">0.045 ETH ($112.50)</p>
              </div>
              <div className="flex justify-between items-end border-t border-[#1E2A3A] pt-6">
                <p className="text-[10px] font-black text-[#8C8C8C] uppercase tracking-widest">Interest Rate</p>
          ...
          <div className="bg-[#111827] p-8 rounded-[12px] border border-[#1E2A3A] flex flex-col group hover:border-[#F5A623]/30 transition-all opacity-80 cursor-not-allowed">
            <div className="w-14 h-14 rounded-xl bg-[#1E2A3A] border border-[#1E2A3A] flex items-center justify-center text-[#8C8C8C] mb-8">
              <iconify-icon icon="lucide:trending-up" className="text-2xl"></iconify-icon>
            </div>
            <h3 className="text-xl font-black font-cabinet text-[#FAFAF8] mb-3 uppercase tracking-widest">Reputation Only</h3>
            ...
            <button disabled className="w-full py-4 border border-[#1E2A3A] text-[#8C8C8C] rounded-[8px] text-[10px] font-black uppercase tracking-widest">
              Limit $10
            </button>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          <div className="lg:col-span-3 bg-[#111827] p-10 rounded-[12px] border border-[#1E2A3A]">
            <h4 className="text-lg font-black font-cabinet tracking-tight text-[#FAFAF8] uppercase tracking-widest mb-10">Loan Infrastructure</h4>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                 {['Daily', 'Weekly', 'Seasonal'].map(type => (
                   <button key={type} className={`py-4 rounded-xl border font-black text-[10px] uppercase tracking-widest transition-all
                    ${type === 'Weekly' ? 'bg-[#F5A623] text-black border-[#F5A623]' : 'bg-[#0A0F1E] text-[#8C8C8C] border-[#1E2A3A] hover:border-[#F5A623]'}`}>
                      {type} Cycle
                   </button>
                 ))}
              </div>

              <div className="p-8 rounded-xl bg-[#0A0F1E] border border-[#1E2A3A]">
                ...
                <div className="space-y-4">
                  {[1, 2, 3, 4, 5, 6].map(i => (
                    <div key={i} className="flex justify-between items-center text-[11px]">
                      ...
                      <span className="text-[#FAFAF8] font-mono">$13.12</span>
                      <span className="text-[#8C8C8C] text-[9px] uppercase">Due Nov {0 + i * 7}</span>
                    </div>
                  ))}
                  <div className="pt-6 border-t border-[#1E2A3A] flex justify-between items-center text-xl font-black font-cabinet">
                    <span className="text-[#FAFAF8] tracking-tight uppercase text-sm">Total Repayment</span>
          ...
          <div className="space-y-8">
            <div className="bg-[#111827] p-8 rounded-[12px] border border-[#1E2A3A]">
              ...
              <div className="text-center py-6">
                <p className="text-5xl font-black font-cabinet text-[#FAFAF8]">68</p>
